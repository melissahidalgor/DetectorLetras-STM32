...
#define AI_NETWORK_MODEL_SIGNATURE     "0x49584c74c270de0ff03e52c0546b32f4"
...
#define AI_TOOLS_DATE_TIME   "2025-10-07T18:39:39-0600"
...
/* Array#5 */
AI_ARRAY_OBJ_DECLARE(
  dense_17_dense_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 3, AI_STATIC)

/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  dense_17_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 3, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 20, 3, 1, 1), AI_STRIDE_INIT(4, 4, 80, 240, 240),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 6452, 1, 1),
    6452, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 200, 1, 1),
    200, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_17_output),
  &dense_15_dense_layer, 0xd7568f58, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_15_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_15_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    dense_15_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_15_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    dense_16_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 120);
    dense_16_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 120);
    dense_16_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_16_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    dense_17_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    dense_17_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_15_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 0);
    dense_15_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    dense_15_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_15_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 3600);
    dense_15_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3600);
    dense_16_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_16_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 3720);
    dense_16_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 3720);
    dense_16_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_16_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 6120);
    dense_16_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 6120);
    dense_17_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_17_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 6200);
    dense_17_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 6200);
    dense_17_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_17_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 6440);
    dense_17_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 6440);
    return true;
  }
